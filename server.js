...
app.post("/recipes", jsonParser, (req,res) => {
  ...
  for(let i = 0; i < requiredRecipeFields; i++){
    const recipeField = requiredRecipeFields[i];
    if(!(recipeField in req.body)){
      const errorMsg = `Missing ${recipeField} in request body!!`;
